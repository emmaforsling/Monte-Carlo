...
int main(int argc, char *argv[])
{
	...
	*/
	...
	Sphere* sphereSpecular2 = new Sphere(glm::dvec3(4.0, 1.0, 3.0), 1.0, false, refractiveIndexForSphereSpecular, glm::dvec3(0.0, 0.0, 0.0), false );
